...
using System.Linq;
using System.Web;
using Barapido.Models.Enums;
using NHibernate.Cfg;
using Barapido.Utilities.Productivity;
...
using Barapido.Utilities.NHibernate;
using Barapido.Models;


namespace Barapido.Utilities {
	...
	public class HibernateSession {
		...
		private static void BuildMsSqlSchema(Configuration config, bool forceCreate = false) {
			...
			var dir = Path.Combine(Path.GetTempPath(), "Barapido");
